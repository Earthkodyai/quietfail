...
--
-- noise_scale 0.35 เลือกให้ query ไม่ทับจุดศูนย์กลางเป๊ะ แต่ยังอยู่ในกลุ่ม
-- (ค่านี้เป็นพารามิเตอร์ของ **ข้อมูลทดลอง** ไม่ใช่ของ index
--  จึงไม่ขัดกฎเหล็กข้อ 2 ซึ่งคุมค่า m / ef_search / lists / probes)
-- =============================================================
\set noise 0.35

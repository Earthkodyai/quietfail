...
BEGIN
    ...
    RAISE NOTICE '';
    -- 🔴 ข้อความเดิมตรงนี้เขียนว่า "ตัวที่ปลดล็อกคือ work_mem ซึ่งไม่มีในรายการ
    --    ข้อจำกัดของเอกสาร" — **ถอนแล้ว 2026-08-01 (E42)** และเป็นข้ออ้างที่
    --    เริ่มการทวนทั้งชุด · แก้ป้ายในตารางไปแล้วตั้งแต่รอบนั้น แต่ **บล็อกสรุป
    --    ตรงนี้ถูกลืม** จึงยังพิมพ์ข้ออ้างที่ถอนแล้วออกมาทุกครั้งที่รัน
    --    รวมทั้งตอนรัน --reproduce (แก้ 2026-08-02)
    RAISE NOTICE '⭐ ค่าเริ่มต้นไม่พอ และไม่มีสัญญาณบอกว่ายังหมุนไม่พอ';
    RAISE NOTICE '   ⚠️ **ห้ามอ่านว่า work_mem เป็นปุ่มที่เอกสารไม่มี** — ข้ออ้างนั้นถอนแล้ว';
    RAISE NOTICE '   เอกสารนิยาม hnsw.scan_mem_multiplier ว่าเป็น "a multiple of work_mem"';
    RAISE NOTICE '   ทั้งสองจึงเป็นปุ่มเดียวกัน · ที่ multiplier = 32 ได้ครบ 40 แถว';
    RAISE NOTICE '   โดยไม่แตะ work_mem เลย (results/q03_multiplier_probe.txt)';
    RAISE NOTICE '   ตารางข้างบนหยุดที่ multiplier = 8 ซึ่ง **ไล่ค่าไม่ไกลพอ**';
END $$;

...
--
-- 🔴 ผลที่ได้: **ข้ออ้างข้างบนถูกถอน** — บนข้อมูลจริง probes=5 ได้ 0.9068
--    และ probes=10 ตามสูตรเอกสารได้ 0.9527 ซึ่งดีกว่าจริง -> เอกสารแนะนำเหมาะสม
--    ⚠️ และ E45 พบว่าแถว probes สูง (>=50) planner เลิกใช้ index เอง
--       ตามที่เอกสารเตือนไว้ ("the planner won't use the index")
--
...
--    เก็บกวาดด้วยมือ:  DROP INDEX IF EXISTS qf_real_ivf;

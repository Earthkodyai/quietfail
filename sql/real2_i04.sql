...
-- 🔴🔴 ไฟล์นี้สร้าง index **บน qf_real2 โดยตรง** ไม่ได้ทำสำเนา — 15 ครั้งต่อการรัน
...
-- ============================================================
-- 🔴 เดิมลบ qf_i04r2_ans แต่ตอนต้นไฟล์ (กับดักข้อ 14ฐ · ไฟล์ที่ 9)
DO $$
...
DROP TABLE IF EXISTS qf_i04r2_ans CASCADE;

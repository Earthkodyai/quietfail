-- ============================================================
-- Q06 บน embedding จริง — วัดตำแหน่งเพดาน
--
-- 🔴 ผลที่ได้: **เพดานอยู่ที่ 41 ไม่ใช่ 40** หน้าผาจึงอยู่ที่ k = ef_search + 2
--    กลไก (มีเพดานตายตัว ขอเพิ่มไม่ช่วย) ยกข้ามชุดข้อมูลได้ · ตำแหน่งยกไม่ได้
...
--    เก็บกวาดด้วยมือ:  DROP INDEX IF EXISTS qf_q06r_idx;
...
DROP TABLE IF EXISTS qf_q06r_obs CASCADE;

...
# ══════════════════════════════════════════════════════════════
# ⚠️ results/README.md เพิ่งถูกเพิ่ม 2026-08-02 — เดิมไม่อยู่ในรายการนี้
#    จึงไม่มีอะไรตรวจตัวเลขในนั้นเลย และมันเก่าค้างไปไกลที่สุดในบรรดาเอกสารทั้งหมด
#    (ตารางหลักฐานหยุดที่ 36 ไฟล์ ขณะที่ของจริงมี 67)
